...
def imageRetrieval(directoryInput, images_retrieved, activityLogFile):                       # Function Retrieves Images from Directory and Stores In 'images_retrieved' array
    imageIntegrity(images_retrieved)                                        # Sends Retrieved Images to get checked for file integrity
    activityLogFile.write("Searching for images in input directory...\n")
